...
urlpatterns = [
    ...
    path(
        ...
        PasswordResetView.as_view(
            template_name="Users/password_reset.html", form_class=PasswordReset
        ),
        name="password_reset",
    ),
    path(
    ...
    path(
        ...
        PasswordResetConfirmView.as_view(
            template_name="Users/password_reset_confirm.html", form_class=SetPassword
        ),
    ...
    path(
        ...
        UserPasswordChangeView.as_view(
            template_name="Users/change_password.html", form_class=SetPassword
        ),
